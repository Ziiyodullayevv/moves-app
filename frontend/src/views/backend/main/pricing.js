                    ...
                    <thead>
                      <tr>
                        ...
                        <th className="text-center iq-price-head free">
                          <div
                            className={`iq-price-box ${pricing === "Basic" ? "active" : ""} `}
                        ...
                        <th className="text-center iq-price-head premium">
                          <div
                            className={`iq-price-box  ${pricing === "pricing" ? "active" : ""}`}
                            onClick={() => setPricing("pricing")}
                          >
                            <h3 className="iq-price-rate text-white">
                              $39<small> / 3 Months</small>
                            </h3>
                        ...
                        <th className="text-center iq-price-head basic">
                          <div
                            className={`iq-price-box ${pricing === "Platinum" ? "active" : ""}`}
                    ...
                    <tbody>
                      {pricingLists.map((item) => (
                        <tr key={item.title}>
                          ...
                          <td
                            className={`text-center iq-child-cell ${pricing === "Basic" ? "active" : ""}`}
                          >
                            <i className={`${item.icon}`}></i>
                          </td>
                          <td
                            className={`text-center iq-child-cell ${pricing === "pricing" ? "active" : ""}`}
                          >
                            <i className={`${item.icon1}`}></i>
                          </td>
                          <td
                            className={`text-center iq-child-cell ${pricing === "Platinum" ? "active" : ""}`}
                          >
